...
```
系统变量
EFAULT_MAVEN_HOST=https://storage.flutter-io.cn;
...
distributionUrl=file\:///E:/project/my_flutter/gradle/gradle-7.5-all.zip
...
用户的变量 
ANDROID_HOME=D:\ANDROID_STUDIO\SDK;
ANDROID_SDK_HOME=D:\ANDROID_STUDIO\.android; // 创建android 模拟器 安装路径

// 里面的 distributionBase 和 zipStoreBase 对应的值都是 GRADLE_USER_HOME，其中 distributionBase 表示下载的 Gradle 压缩包解压后存储的主目录，zipStoreBase 表示 Gradle 发行版压缩包的下载地址。

GRADLE_USER_HOME=D:\ANDROID_STUDIO\.gradle; 
